...
/**
 * Main configuration interface to Xlite. Configures mappings between Classes and XML.
 * <p/>
 * <b>Example usage:</b>
 * <pre>
 * Configuration conf = new Configuration(One.class);  // intialize and define first class mapping
 * conf.addMapping(Two.class);                         // add second class mapping
 * </pre>
 * Please look at Xlite documentation for more detailed explanation of mapping configuration.
 */
public class Configuration {
    ...
    /**
     * Initializes Configuration and adds a annotated class mapping.
     *
     * @param rootClass Class containing XML mapping annotations
     */
    public Configuration(Class rootClass) {
        this();
    ...
    /**
     * Initializes Configuration and adds a XML-configured mapping.
     *
     * @param xmlReader Reader containing XML-configured mapping.
     */
    public Configuration(Reader xmlReader) {
        this();
